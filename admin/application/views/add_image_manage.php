    ...
    <div class="my-3 my-md-5 app-content">
      <div class="side-app">
        <div class="page-header">
          <h4 class="page-title">Add Image For Gallery
          </h4>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Image Manage
            </li>
          </ol>
        </div>
        <div class="row">
            ...
            <form  method="post" class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4 col-lg-4">
                    <div class="form-group">
                      <label class="form-label">Image Title
                      </label>
                ...
                <div class="row">
                  <div class="col-md-4 col-lg-4">
                    <div class="form-group">
                      <label class="form-label">Upload Main Image (max 1000KB)
                      </label>
                  ...
                  <div class="col-md-4 col-lg-4">
                    <div class="form-group">
                      <label class="form-label">Upload Thumb Image (max 500KB)
                      </label>
                       <div class="custom-file">
                        <input type="file" class="custom-file-input" name="example-file-input-custom">
                        <label class="custom-file-label">Choose file
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                      <label class="form-label">Enter Image Description
                      </label>
